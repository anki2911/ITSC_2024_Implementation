...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/North_Region/North_Region/Dataset-7/osm.sumocfg"]
...
f = open("Road_Trace_134996386.txt","w")
f.write("134996386" + "\n")
...
traci.vehicle.setRoute('veh0',['134996386'])
