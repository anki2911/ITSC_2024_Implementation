...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/North_Region/North_Region/Dataset-12/osm.sumocfg"]
...
f = open("Road_Trace_481619882.txt","w")
f.write("481619882" + "\n")
...
#Valid Routes
traci.vehicle.setRoute('veh0',['481619882'])
