...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/Central_Region/Central_Region/Dataset-14/osm.sumocfg"]
...
f = open("Road_Trace_814472953-AddedOnRampEdge.txt","w")
f.write("814472953-AddedOnRampEdge" + "\n")
...
#Valid Routes
traci.vehicle.setRoute('veh0',['814472953-AddedOnRampEdge'])
