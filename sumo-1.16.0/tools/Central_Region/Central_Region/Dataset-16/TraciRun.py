...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/Central_Region/Central_Region/Dataset-16/osm.sumocfg"]
...
f = open("Road_Trace_477025178.txt","w")
f.write("477025178" + "\n")
...
#Valid Routes
traci.vehicle.setRoute('veh0',['477025178'])
