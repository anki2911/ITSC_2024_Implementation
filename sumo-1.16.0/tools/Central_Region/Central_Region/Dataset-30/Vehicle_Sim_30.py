...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/Central_Region/Central_Region/Dataset-30/osm.sumocfg"]
...
f = open("Trace_305.txt","w")

#Succesful Route_1
#traci.vehicle.setRoute('veh0',['462871390','478876321-AddedOnRampEdge','478876321'])
#Successful Route_2
#traci.vehicle.setRoute('veh0',['75351818','478876321-AddedOnRampEdge','478876321'])
#Successful Route_3
#traci.vehicle.setRoute('veh0',['15773055','262190478','631885735-AddedOnRampEdge','631885735'])
#Successful Route_4
#traci.vehicle.setRoute('veh0',['15772713','262190481','632498927'])
#Successful Route_5
traci.vehicle.setRoute('veh0',['15773693'])
