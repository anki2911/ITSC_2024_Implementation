...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/South_Region/South_Region/Dataset-17/osm.sumocfg"]
...
f = open("Road_Trace_75231495#0.txt","w")
f.write("75231495#0" + "\n")
...
#Valid Routes
traci.vehicle.setRoute('veh0',['75231495#0'])
