...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/South_Region/South_Region/Dataset-30/osm.sumocfg"]
...
f = open("Trace_302.txt","w")

#Successful Route_1
#traci.vehicle.setRoute('veh0',['16894438'])
#Successful Route_2
traci.vehicle.setRoute('veh0',['45248319'])
