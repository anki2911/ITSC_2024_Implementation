...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/South_Region/South_Region/Dataset-23/osm.sumocfg"]
...
f = open("Trace_231.txt","w")

#Successful Route_1
traci.vehicle.setRoute('veh0',['383372421#1'])
