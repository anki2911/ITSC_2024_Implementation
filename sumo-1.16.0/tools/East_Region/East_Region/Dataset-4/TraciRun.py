...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/East_Region/East_Region/Dataset-4/osm.sumocfg"]
...
#Succesful Route_1
#traci.vehicle.setRoute('veh0',['630093161','649609108','635498363','649609104','743307990'])

#Successful Route_2
#traci.vehicle.setRoute('veh0',['630093161','649609108','44488271','23960766'])

#Successful Route_3
#traci.vehicle.setRoute('veh0',['-23960766','23960768','649609104','743307990'])

#Successful Route_4
#traci.vehicle.setRoute('veh0',['743300413'])

#Successful Route_5
traci.vehicle.setRoute('veh0',['641160520'])


f = open('Road_Trace_-641160520_1.txt','w')
f.write("-641160520" + "\n")
