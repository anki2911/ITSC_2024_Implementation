...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/East_Region/East_Region/Dataset-9/osm.sumocfg"]
...
f = open("Trace_93.txt","w")

#Succesful Route_1
#traci.vehicle.setRoute('veh0',['44957233'])

#Successful Route_2
#traci.vehicle.setRoute('veh0',['44957849','74628659'])

#Successful Route_3
traci.vehicle.setRoute('veh0',['74675125'])

#Successful Route_4
#traci.vehicle.setRoute('veh0',['539042623','476354436','44957236','74628659'])
