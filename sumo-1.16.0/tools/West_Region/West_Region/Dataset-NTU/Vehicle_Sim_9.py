...
sumoCmd = [sumoBinary, "-c", "C:/Users/Ankita/Desktop/sumo-1.16.0/tools/West_Region/West_Region/Dataset-NTU/osm.sumocfg"]
...
f = open("Trace_91.txt","w")

#Successful Route_1
#traci.vehicle.setRoute('veh0',[''])
#Successful Route_2
